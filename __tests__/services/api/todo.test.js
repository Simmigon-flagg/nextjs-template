...
import { findUserByEmail, addTodoToUser, getTodosByUser } from "../../../services/api/todo"; // adjust path as needed
...
describe("getTodosByUser", () => {
  ...
  it("should apply filters, pagination, and sorting correctly", async () => {
    ...
    const result = await getTodosByUser("userId", filters, pagination, sortConfig);
    ...
    expect(mockChain.collation).toHaveBeenCalledWith({ locale: "en", strength: 2 });
